...
### as shown in Figure 17 in Appendix.
library(tidyverse)

## The dataset is generated by running simulation on MOD with privacy parameter
## allocation varied. 
data <- read_csv("data/mod_params.csv")
...
mod_params <- data %>% ggplot(aes(y = moe, x = p, col = as.factor(e))) + 
...
ggsave("mod_params.png", path = "paper/plots", mod_params, device = "png")
