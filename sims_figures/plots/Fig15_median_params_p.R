...
## The dataset is generated by running simulation on CENQ with privacy parameter
## allocation varied. 
data <- read_csv("data/median_params1.csv")
...
median_params_p <- data %>% ggplot(aes(y = moe, x = p, col = as.factor(e))) +
...
ggsave("median_params_p.png", path = "paper/plots", median_params_p, device = "png")
