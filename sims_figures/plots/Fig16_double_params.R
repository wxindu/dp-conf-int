...
### as shown in Figure 16 in Appendix.
library(tidyverse)

## The dataset is generated by running simulation on SYMQ with privacy parameter
## allocation varied. 
data <- read_csv("data/double_params.csv")
...
double_params <- data %>% ggplot(aes(y = moe, x = b, col = as.factor(e))) + 
...
ggsave("double_params.png", path = "paper/plots", double_params, device = "png")
