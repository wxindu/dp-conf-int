...
### as shown in Figure 13 in Appendix.
library(tidyverse)

## The dataset is generated by running simulation on NOISYMAD with privacy parameter
## allocation varied. 
#data <- read_csv("data/abs_params.csv")
...
#ggsave("abs_params.png", path = "paper/plots", abs_params, device = "png")
